...
parser.add_argument("--nepochs", type=int, default=50, help="The maxium number of epochs to train")
...
parser.add_argument('--output_dir',type=str, default='/data/cm/NLP-based_model_code/outputs')
...
def train(model_name, train_path_list, val_path_list, test_path_list, model_save_path, num_epochs, lr, device):
    ...
    if model_name == 'MobileViT':
        ...
        model.load_state_dict(torch.load('/data/cm/MSI/HE2RNA_model/mobilevit_s-38a5a959.pth'))
        print(model)
